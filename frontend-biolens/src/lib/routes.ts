...
export const routes = {
  crops: {
    ...
    logHarvest: (id: number | string) =>
      `${BACKEND}/api/crops/log-harvest/${id}`,
    ...
    diagnoseForCrop: (cropId: number | string) =>
      `${BACKEND}/api/crops/diagnose/${cropId}`,
    diagnoseAuto: `${BACKEND}/api/crops/diagnose-auto`,
    diagnoses: `${BACKEND}/api/crops/diagnoses`,
    diagnosesByCrop: (cropId: number | string) =>
      `${BACKEND}/api/crops/${cropId}/diagnoses`,
    identificationHistory: (cropId: number | string) =>
      `${BACKEND}/api/crops/identification-history/${cropId}`,
  ...
  fields: {
    all: `${BACKEND}/api/fields`,
    byId: (id: number | string) => `${BACKEND}/api/fields/${id}`,
    create: `${BACKEND}/api/fields`,
    update: (id: number | string) => `${BACKEND}/api/fields/${id}`,
    delete: (id: number | string) => `${BACKEND}/api/fields/${id}`,
  },
  users: {
